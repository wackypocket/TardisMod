...
public class MagicDoorTileEntityRenderer extends AbstractObjRenderer {
    ...
    private void renderFace(Tessellator tess, double mX, double MX, double mY, double MY, double mU, double MU,
        double mV, double MV, double z) {
    ...
    private void renderFace(Tessellator tess, ResourceLocation tex, double xP, double yP, double z) {
        ...
        if (xP != 1) renderFace(tess, xP, 1, 0, yP, 0, xO, yO, 1, z);
        if (yP != 1) renderFace(tess, 0, xP, yP, 1, xO, 1, 0, yO, z);
        if ((yP != 1) && (xP != 1)) renderFace(tess, xP, 1, yP, 1, 0, xO, 0, yO, z);
    }
    ...
    private void renderMoving(Tessellator tess, ResourceLocation tex, double divisor, boolean xb, double z) {
        ...
        } else renderFace(tess, tex, 1, 1, z);
    }
