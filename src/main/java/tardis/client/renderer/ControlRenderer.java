...
public class ControlRenderer {
    ...
    protected void bindTexture(ResourceLocation par1ResourceLocation) {
        if (textureManager != null) textureManager.bindTexture(par1ResourceLocation);
    }

    private void handleSettings(double x, double y, double z, double rX, double rY, double rZ, double sX, double sY,
        double sZ) {
    ...
    public void renderTextScreen(Tessellator tess, IControlMatrix tce, String s, int id, double x, double y, double z,
        ...
        // Draw text bright/white: temporarily set full-lightmap only for the FontRenderer draw
        int prevL1 = 0;
        int prevL2 = 0;
        if (tce instanceof TileEntity) {
            TileEntity te = (TileEntity) tce;
            World w = te.getWorldObj();
            if (w != null) {
                int actualLight = w.getLightBrightnessForSkyBlocks(te.xCoord, te.yCoord, te.zCoord, 0);
        ...
        if (s != null) fontRenderer.drawString(s.length() > 18 ? s.substring(0, 18) : s, 0, 0, 0xFFFFFF);
    ...
    public void renderScrewdriverHolder(Tessellator tess, IControlMatrix te, double x, double y, double z, double rX,
    ...
    public void renderScrewdriver(Tessellator tess, IControlMatrix te, int slot, double x, double y, double z,
        double rX, double rY, double rZ, double sX, double sY, double sZ) {
    ...
    public void renderGauge(Tessellator tess, IControlMatrix te, int id, double x, double y, double z, double rX,
        double rY, double rZ, double sX, double sY, double sZ) {
        GL11.glPushMatrix();
        handleSettings(x, y, z, rX, rY, rZ, sX, sY, sZ);
        resetHighlight();
    ...
    public void renderGauges(Tessellator tess, IControlMatrix te, double x, double y, double z, double rX, double rY,
        double rZ, double sX, double sY, double sZ, int... ids) {
        GL11.glPushMatrix();
        handleSettings(x, y, z, rX, rY, rZ, sX, sY, sZ);
        resetHighlight();
        GL11.glPushMatrix();
    ...
    public void renderWheel(Tessellator tess, IControlMatrix te, int id, double x, double y, double z, double rX,
        double rY, double rZ, double sX, double sY, double sZ) {
        GL11.glPushMatrix();
        handleSettings(x, y, z, rX, rY, rZ, sX, sY, sZ);
    ...
    public void renderLight(Tessellator tess, IControlMatrix te, int id, double x, double y, double z, double rX,
        double rY, double rZ, double sX, double sY, double sZ) {
        GL11.glPushMatrix();
        resetHighlight();
        handleSettings(x, y, z, rX, rY, rZ, sX, sY, sZ);
        ...
        if ((colRat != null) && (colRat.length == 3)) GL11.glColor3d(colRat[0] * am, colRat[1] * am, colRat[2] * am);
    ...
    public void renderLever(Tessellator tess, IControlMatrix te, int id, double x, double y, double z, double rX,
        double rY, double rZ, double sX, double sY, double sZ) {
        GL11.glPushMatrix();
        handleSettings(x, y, z, rX, rY, rZ, sX, sY, sZ);
        GL11.glPushMatrix();
    ...
    public void renderSpecialLever(Tessellator tess, IControlMatrix te, int id, double x, double y, double z, double rX,
        double rY, double rZ, double sX, double sY, double sZ) {
        GL11.glPushMatrix();
        handleSettings(x, y, z, rX, rY, rZ, sX, sY, sZ);
        GL11.glPushMatrix();
    ...
    public void renderScreen(Tessellator tess, IControlMatrix te, int id, String texture, double x, double y, double z,
        double rX, double rY, double rZ, double sX, double sY, double sZ) {
        GL11.glPushMatrix();
        handleSettings(x, y, z, rX, rY, rZ, sX, sY, sZ);
        GL11.glPushMatrix();
    ...
    public void renderPushSwitch(Tessellator tess, IControlMatrix tce, int id, double x, double y, double z, double rX,
        double rY, double rZ, double sX, double sY, double sZ) {
        GL11.glPushMatrix();
        handleSettings(x, y, z, rX, rY, rZ, sX, sY, sZ);
        GL11.glPushMatrix();
    ...
    public void renderButton(Tessellator tess, IControlMatrix tce, int id, double x, double y, double z, double rX,
        double rY, double rZ, double sX, double sY, double sZ) {
        GL11.glPushMatrix();
        handleSettings(x, y, z, rX, rY, rZ, sX, sY, sZ);
        GL11.glPushMatrix();
