...
public class ConsoleModel extends ModelBase {
    ...
    public ConsoleModel() {
        ...
        setRotation(
            Arm1,
            (float) Math.toRadians(downAmount),
            (float) Math.toRadians(spinAmount),
            (float) Math.toRadians(0));
        setRotation(
            Arm2,
            (float) Math.toRadians(downAmount),
            (float) Math.toRadians(90 + spinAmount),
            (float) Math.toRadians(0));
        setRotation(
            Arm3,
            (float) Math.toRadians(downAmount),
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        /*
         * setRotation(Arm1, (float)Math.toRadians(-(180-roundAmount)), (float)Math.toRadians(rollAmount),
         * (float)Math.toRadians(180-downAmount));
         * setRotation(Arm2, (float)Math.toRadians(180-roundAmount), (float)Math.toRadians(rollAmount),
         * (float)Math.toRadians(180-downAmount));
         * setRotation(Arm3, (float)Math.toRadians(roundAmount), (float)Math.toRadians(rollAmount),
         * (float)Math.toRadians(downAmount));
         * setRotation(Arm4, (float)Math.toRadians(-roundAmount), (float)Math.toRadians(rollAmount),
         * (float)Math.toRadians(downAmount));
         */
