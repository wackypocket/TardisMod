...
public class CraftingComponentItem extends AbstractItem {
    ...
    static {
        ...
        for (int i = 0; i < names.length; i++) names[i] = types[i].name;
    }
    ...
    public void initRecipes() {
        ...
        if (Configs.kontronCraftable) GameRegistry.addRecipe(
            new ShapedOreRecipe(
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                CraftingComponentType.UPGRADE.getIS(1),
                false,
                "gcg",
                "gig",
                "gcg",
        ...
        LabRecipeRegistry.addRecipe(
            new LabRecipe(
                "tm.upgrade",
                new ItemStack[] { new ItemStack(TMRegistry.upgradeItem, 1, 0),
                    CraftingComponentType.CHRONOSTEEL.getIS(1) },
