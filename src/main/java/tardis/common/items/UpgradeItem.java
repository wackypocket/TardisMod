...
public class UpgradeItem extends AbstractItem {
    ...
    private final static String[] upgradeTypes = new String[] { "broken", "protExpl", "protComb", "protMiss", "speed",
        "shield", "room", "energy", "energyRegen" };
    ...
    public void addInfo(ItemStack is, EntityPlayer player, List<String> infoList) {
        if (is != null) {
            ...
            int health = io.darkcraft.darkcore.mod.nbt.NBTUtils.getInt(nbt, "health", -1);
            if (health >= 0) infoList.add("Health:" + health);
        }
    }
