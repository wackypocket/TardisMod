...
public class TardisWorldSkyRenderer extends IRenderHandler {
    ...
    private static final ResourceLocation locationOrangeSunPng = new ResourceLocation(
        "tardismod",
        "textures/environment/OrangeSun.png");
    ...
    public void render(float p_72714_1_, WorldClient theWorld, Minecraft mc) {
        ...
        GL11.glPushMatrix();
        GL11.glRotatef(
            ((TardisWorldProvider) theWorld.provider).calculateRealCelestialAngle(p_72714_1_) * 360.0F,
            0.0F,
            1.0F,
            0.0F);
        renderStars();
        ...
        GL11.glRotatef(
            -((((TardisWorldProvider) theWorld.provider).calculateRealCelestialAngle(p_72714_1_) * 4) * 360.0F),
            1F,
            2F,
            1.5F);
        f10 = 15.0F;
        ...
        GL11.glRotatef(
            ...
            0.0F);
        GL11.glRotatef(
            -(((TardisWorldProvider) theWorld.provider).calculateRealCelestialAngle(p_72714_1_) * 2) * 360.0F,
            0.2F,
            0.5F,
            1.3F);
