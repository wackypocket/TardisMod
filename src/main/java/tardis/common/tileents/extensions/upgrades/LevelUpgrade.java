...
public class LevelUpgrade extends AbstractUpgrade {
    ...
    private static HashMap<TardisUpgradeMode, ResourceLocation> resMap = new HashMap<TardisUpgradeMode, ResourceLocation>();
    ...
    public ResourceLocation getTexture() {
        if (resMap.containsKey(tum)) return resMap.get(tum);
