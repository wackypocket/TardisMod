...
public class BatteryBlock extends AbstractScrewableBlockContainer {
    ...
    public ItemStack getIS(int am, int dam) {
        ...
        NBTTagCompound d;
        if (is.stackTagCompound == null) d = new NBTTagCompound();
        else d = is.stackTagCompound;
        d.setInteger("ae", 0);
    ...
    public void initRecipes() {
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                getIS(1, 0)));
        LabRecipeRegistry
            .addRecipe(new LabRecipe("tm.battery3", getIS(1, 1), getIS(1, 2), EnumSet.of(LabFlag.INFLIGHT), 200));
    }
