...
public class Colour {
    ...
    /**
     * This long represents the colour in the same way the minecraft font renderer does, but has the most significant
     * byte as the alpha
     */
    @NBTProperty
    ...
    public boolean equals(Object o) {
        if (o instanceof Colour) return asLong == ((Colour) o).asLong;
        return false;
    }
}
