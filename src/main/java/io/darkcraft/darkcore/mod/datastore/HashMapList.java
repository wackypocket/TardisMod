...
public class HashMapList<K, V> {
    ...
    private final Iterator<V> deadIter = new Iterator<V>() {
    ...
    public boolean add(K key, V value) {
        if (!map.containsKey(key)) put(key, new ArrayList<V>());
    ...
    public Iterator<V> iterator() {
        Iterator<V> i = new Iterator<V>() {
            ...
            private Iterator<K> keyIter = map.keySet()
                .iterator();
            ...
            public boolean hasNext() {
                setNextIter();
                if ((valIter == null) || !valIter.hasNext()) return false;
                return true;
            }
            ...
            public V next() {
                setNextIter();
                prevIter = valIter;
                if ((valIter != null) && valIter.hasNext()) return valIter.next();
                return null;
            }
    ...
    public boolean equals(Object o) {
        ...
        HashMapList<K, V> h = (HashMapList<K, V>) o;
