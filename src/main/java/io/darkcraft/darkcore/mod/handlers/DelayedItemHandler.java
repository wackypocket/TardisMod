...
public class DelayedItemHandler {
    ...
    public static void addItemDrop(EntityPlayer pl, List<ItemStack> itemstack) {
        ...
        for (ItemStack is : itemstack) addItem(is, isMap);
    }
