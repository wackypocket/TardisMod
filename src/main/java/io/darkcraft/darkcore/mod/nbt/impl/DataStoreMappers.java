...
public class DataStoreMappers {
    ...
    public static class PlayerContainerMapper extends Mapper<PlayerContainer> {
        ...
        public PlayerContainer fillFromNBT(NBTTagCompound nbt, PlayerContainer t) {
            ...
            if ((t == null) || !t.getUUID()
                .equals(uuid)) return createFromNBT(nbt);
            return t;
        }
    ...
    public static class EntityContainerMapper extends PrimMapper<EntityContainer> {
        ...
        public EntityContainer readFromNBT(NBTTagCompound nbt, String id) {
            IEntityContainer cont = EntityContainer.readFromNBT(NBTUtils.getCompoundOrEmpty(nbt, id));
            if (cont instanceof EntityContainer) return (EntityContainer) cont;
            return null;
        }
    }
    ...
    public static class EntityLBContainerMapper extends PrimMapper<EntityLivingBaseContainer> {
        ...
        public EntityLivingBaseContainer readFromNBT(NBTTagCompound nbt, String id) {
            IEntityContainer cont = EntityContainer.readFromNBT(NBTUtils.getCompoundOrEmpty(nbt, id));
            if (cont instanceof EntityLivingBaseContainer) return (EntityLivingBaseContainer) cont;
            return null;
        }
    }
    ...
    public static class EntityMapper extends PrimMapper<Entity> {
        ...
        private final Mapper<IEntityContainer> mapper = NBTHelper
            .getMapper(IEntityContainer.class, SerialisableType.TRANSMIT);
    ...
    public static class Vec3Mapper extends PrimMapper<Vec3> {
        ...
        public Vec3 readFromNBT(NBTTagCompound nbt, String id) {
            NBTTagCompound snbt = NBTUtils.getCompoundOrEmpty(nbt, id);
            double x = io.darkcraft.darkcore.mod.nbt.NBTUtils.getDouble(snbt, "x", 0d);
            double y = io.darkcraft.darkcore.mod.nbt.NBTUtils.getDouble(snbt, "y", 0d);
            double z = io.darkcraft.darkcore.mod.nbt.NBTUtils.getDouble(snbt, "z", 0d);
