...
public class BasicMappers {
    ...
    public static Mapper<String> stringMapper = new PrimMapper<String>() {
        ...
        @Override
        public void writeToNBT(NBTTagCompound nbt, String id, String t) {
            nbt.setString(id, t);
        }

        @Override
        public String readFromNBT(NBTTagCompound nbt, String id) {
            return io.darkcraft.darkcore.mod.nbt.NBTUtils.getString(nbt, id, "");
        }
    };
    ...
    public static Mapper<Byte> byteMapper = new PrimMapper<Byte>() {
        ...
        @Override
        public void writeToNBT(NBTTagCompound nbt, String id, Byte t) {
            nbt.setByte(id, t);
        }

        @Override
        public Byte readFromNBT(NBTTagCompound nbt, String id) {
            return io.darkcraft.darkcore.mod.nbt.NBTUtils.getByte(nbt, id, (byte) 0);
        }
    };
    ...
    public static Mapper<byte[]> byteArrMapper = new PrimMapper<byte[]>() {
        ...
        @Override
        public void writeToNBT(NBTTagCompound nbt, String id, byte[] t) {
            nbt.setByteArray(id, t);
        }

        @Override
        public byte[] readFromNBT(NBTTagCompound nbt, String id) {
            return io.darkcraft.darkcore.mod.nbt.NBTUtils.getByteArray(nbt, id);
        }
    };
    ...
    public static Mapper<Integer> intMapper = new PrimMapper<Integer>() {
        ...
        @Override
        public void writeToNBT(NBTTagCompound nbt, String id, Integer t) {
            nbt.setInteger(id, t);
        }

        @Override
        public Integer readFromNBT(NBTTagCompound nbt, String id) {
            return io.darkcraft.darkcore.mod.nbt.NBTUtils.getInt(nbt, id, 0);
        }
    };
    ...
    public static Mapper<int[]> intArrMapper = new PrimMapper<int[]>() {
        ...
        @Override
        public void writeToNBT(NBTTagCompound nbt, String id, int[] t) {
            nbt.setIntArray(id, t);
        }

        @Override
        public int[] readFromNBT(NBTTagCompound nbt, String id) {
            return io.darkcraft.darkcore.mod.nbt.NBTUtils.getIntArray(nbt, id);
        }
    };
    ...
    public static Mapper<Long> longMapper = new PrimMapper<Long>() {
        ...
        @Override
        public void writeToNBT(NBTTagCompound nbt, String id, Long t) {
            nbt.setLong(id, t);
        }

        @Override
        public Long readFromNBT(NBTTagCompound nbt, String id) {
            return io.darkcraft.darkcore.mod.nbt.NBTUtils.getLong(nbt, id, 0L);
        }
    };
    ...
    public static Mapper<Double> doubleMapper = new PrimMapper<Double>() {
        ...
        @Override
        public void writeToNBT(NBTTagCompound nbt, String id, Double t) {
            nbt.setDouble(id, t);
        }

        @Override
        public Double readFromNBT(NBTTagCompound nbt, String id) {
            return io.darkcraft.darkcore.mod.nbt.NBTUtils.getDouble(nbt, id, 0.0);
        }
    };
    ...
    public static Mapper<Boolean> boolMapper = new PrimMapper<Boolean>() {
        ...
        @Override
        public void writeToNBT(NBTTagCompound nbt, String id, Boolean t) {
            nbt.setBoolean(id, t);
        }

        @Override
        public Boolean readFromNBT(NBTTagCompound nbt, String id) {
            return io.darkcraft.darkcore.mod.nbt.NBTUtils.getBoolean(nbt, id, false);
        }
    };
    ...
    public static Mapper<ItemStack> isMapper = new Mapper<ItemStack>() {
        ...
        public ItemStack fillFromNBT(NBTTagCompound nbt, ItemStack o) {
            if (o == null) return createFromNBT(nbt);
            ItemStack t = o;
            t.readFromNBT(nbt);
            return t;
        }
    ...
    public static Mapper<NBTBase> nbtMapper = new PrimMapper<NBTBase>() {
        ...
        public NBTBase readFromNBT(NBTTagCompound nbt, String id) {
            return io.darkcraft.darkcore.mod.nbt.NBTUtils.getTag(nbt, id);
        }
    };
    ...
    public static Mapper<NBTTagCompound> nbtTagCompoundMapper = new PrimMapper<NBTTagCompound>() {
        ...
        public NBTTagCompound readFromNBT(NBTTagCompound nbt, String id) {
            return io.darkcraft.darkcore.mod.nbt.NBTUtils.getCompoundOrEmpty(nbt, id);
        }
    };
}
