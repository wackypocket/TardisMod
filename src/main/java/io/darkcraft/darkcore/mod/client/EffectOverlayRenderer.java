...
public class EffectOverlayRenderer extends Gui {
    ...
    public static void refreshConfigs() {
        ...
        displayUnlimited = config
            .getBoolean("Display Unlimited", true, "If true, effects with no duration will be visible in the overlay");
        displayOver1m = config.getBoolean(
            "Display Over 1 m",
            true,
            "If true, effects with durations longer than 1m will be visible in the overlay");
        xo = config
            .getDouble("X Offset", 0.35, "The x offset relative to screen resolution that the overlay will render at");
        yo = config
            .getDouble("Y Offset", 0.005, "The y offset relative to screen resolution that the overlay will render at");
