...
public class ConfigItem {
    ...
    private String parseComments(Object defaultVal, String... comments) {
        ...
        for (String s : comments) {
            ...
            for (String m : d) {
                if (m.toLowerCase()
                    .contains("default:")) defaultIncluded = true;
                if (m.startsWith("#")) finalStr += (started ? "\n" : "") + m;
                else finalStr += (started ? "\n" : "") + "#" + m;
                started = true;
            }
        }
    ...
    protected String printable() {
        StringBuilder sb;
        if (com != null) sb = new StringBuilder(getComment()).append("\n");
        else sb = new StringBuilder();
        sb.append(id)
            .append(":")
            .append(type.getPrintable())
            .append(":");
