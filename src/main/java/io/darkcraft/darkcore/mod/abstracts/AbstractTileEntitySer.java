...
public class AbstractTileEntitySer extends AbstractTileEntity {
    ...
    public Packet getDescriptionPacket() {
        ...
        if (TRANS_MAPPER != null) TRANS_MAPPER.writeToNBT(tag, this);
    ...
    public void onDataPacket(NetworkManager net, S35PacketUpdateTileEntity packet) {
        ...
        if (TRANS_MAPPER != null) TRANS_MAPPER.fillFromNBT(nbt, this);
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        if (WORLD_MAPPER != null) WORLD_MAPPER.fillFromNBT(nbt, this);
    }

    @Override
    public void writeToNBT(NBTTagCompound nbt) {
        super.writeToNBT(nbt);
        if (WORLD_MAPPER != null) WORLD_MAPPER.writeToNBT(nbt, this);
    }
}
