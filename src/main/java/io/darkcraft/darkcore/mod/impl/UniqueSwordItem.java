...
public class UniqueSwordItem extends AbstractItem {
    ...
    static {
        ...
        cMap.put("Wackypocket", new double[] { 0.3, 0.8, 1 });
    }
    ...
    public static boolean isValid(Object o) {
        ...
        else if (o instanceof EntityPlayer) name = ServerHelper.getUsername((EntityPlayer) o);
        else return false;
    ...
    public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity) {
        ...
        /*
         * if(entity instanceof EntityLivingBase) { EntityLivingBase ent = (EntityLivingBase) entity;
    ...
    public ItemStack onItemRightClick(ItemStack is, World w, EntityPlayer pl) {
         ...
         * Vec3 end = Vec3.createVectorHelper(pl.posX + (dist * xo), pl.posY + pl.eyeHeight + (dist * yo), pl.posZ +
         * (dist * zo));
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put(
            ...
            new AttributeModifier(field_111210_e, "Weapon modifier", 160, 0));
        return multimap;
    }
