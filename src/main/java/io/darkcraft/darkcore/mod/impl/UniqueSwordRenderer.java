...
public class UniqueSwordRenderer implements IItemRenderer {
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (type == ItemRenderType.EQUIPPED_FIRST_PERSON) {
            ...
            if (type == ItemRenderType.INVENTORY) GL11.glTranslated(0, -0.5, 0);
            else GL11.glTranslated(0, 0.4, 0);
        }
        renderBit(deco, "Deco_Cube.003");
        String pl = null;
        for (Object o : data) if (o instanceof EntityPlayer) pl = ServerHelper.getUsername((EntityPlayer) o);
        if (!UniqueSwordItem.isValid(pl)) return;
