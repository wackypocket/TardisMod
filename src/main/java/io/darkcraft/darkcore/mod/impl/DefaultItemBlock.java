...
public class DefaultItemBlock extends AbstractItemBlock {
    ...
    public DefaultItemBlock(Block par1) {
        super(par1);
        if (par1 instanceof AbstractBlock) b = (AbstractBlock) par1;
        else b = null;
    }
    ...
    public void addInfo(ItemStack is, EntityPlayer player, List infoList) {
        ...
        if (b instanceof AbstractBlock) ((AbstractBlock) b)
            .addInfo(is.getItemDamage(), NBTUtils.getCompoundOrEmpty(is.stackTagCompound, ""), infoList);
    }
}
